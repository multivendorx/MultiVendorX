        ...
        <div className="mvx-header-wapper">
          ...
          <div className="mvx-header-nav-right-section">
            <div className="mvx-header-search-section">
              ...
              <input type="text" placeholder={appLocalizer.search_module} onChange={(e) => this.handleOnChange(e)} />
                ...
                <div className="mvx-search-content">
                  {this.state.fetch_all_settings_for_searching.map((data, index) => (
                    <div className="mvx-header-search-content-wrapper">
                      <a href={data.link}>
                        <div className="mvx-header-search-contetnt-label">{data.label}</div>
                        <p className="mvx-header-search-contetnt-desc" dangerouslySetInnerHTML={{ __html: data.desc }}></p>
                      </a>
                    </div>
                  ))}
                </div>
