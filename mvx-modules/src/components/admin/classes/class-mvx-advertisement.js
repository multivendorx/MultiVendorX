...
class Advertisement extends React.Component {
  ...
  handleAdvertisementFilter(e, status) {
    if (status === "searchstatus") {
      if (e) {
        axios
          .get(
            `${appLocalizer.apiUrl}/mvx_module/v1/show_advertisement_from_list`,
            {
              params: { adv_status: e.value },
            }
          )
          .then((response) => {
            this.setState({
        ...
        axios({
          url: `${appLocalizer.apiUrl}/mvx_module/v1/all_advertisement`,
        }).then((response) => {
          this.setState({
            data_adv: response.data,
          });
  ...
  different_adv_status(e, type) {
    ...
    if (type === "active") {
      ...
      axios({
        url: `${appLocalizer.apiUrl}/mvx_module/v1/active_advertisement`,
      }).then((response) => {
        this.setState({
          data_adv: response.data,
          adv_loading: true,
      ...
      axios({
        url: `${appLocalizer.apiUrl}/mvx_module/v1/expire_advertisement`,
      }).then((response) => {
        this.setState({
          data_adv: response.data,
          adv_loading: true,
  ...
  handleAdvertisementSearch(e) {
    if (e.target.value) {
      axios
        .get(
          `${appLocalizer.apiUrl}/mvx_module/v1/specific_search_advertisement`,
          {
  ...
  handleBulkActions(e) {
    if (e) {
      if (confirm(appLocalizer.global_string.sure_text) === true) {
        axios({
          method: "post",
          url: `${appLocalizer.apiUrl}/mvx_module/v1/advertisement_bulk_actions`,
          data: {
  ...
  handleStoreSelectBoxModal(e) {
    if (e) {
      axios
        .get(
          `${appLocalizer.apiUrl}/mvx_module/v1/show_products_for_particular_store_id`,
          {
  ...
  handleAddAdvModal() {
    axios
      .get(
        `${appLocalizer.apiUrl}/mvx_module/v1/add_advertisement_form_admin`,
        {
          ...
          <div className="mvx-middle-container-wrapper">
            <div className="mvx-page-title">
              ...
              >
                ...
                <DialogContent>
                  <DialogContentText>
                    <div className="mvx-module-dialog-content">
                      ...
                      <Select
                        placeholder={
                          appLocalizer.advertising_page_string.show_all_products
                        }
                ...
                <DialogActions>
                  <button onClick={this.handleAddAdvModal} color="primary">
                    Add
                  </button>
                </DialogActions>
              </Dialog>
            ...
            <div className="mvx-wrap-bulk-all-date">
              <Select
                ...
                onChange={(e) =>
                  this.handleAdvertisementFilter(e, "searchstatus")
                }
              />
              <Select
                placeholder={
