		...
		return (
			<div className="mvx-sidebar">
				...
				<div className='mvx-banner-right'>
					...
					<a href="https://github.com/wcmarketplace/MultivendorX/issues/new/choose">Git your ticket.</a> And as always don't share your experience and help us improve!</p>
				</div>
			</div>
		);
	}
