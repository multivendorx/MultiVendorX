      ...
      <div className="container">
        ...
        <div className="general-tab-area">
          ...
          {appLocalizer.mvx_all_backend_tab_list['marketplace-analytics'].map((data, index) => (
              <li className={queryt.get("name") == data.tabname ? 'activegeneraltabs' : ''}><i class="mvx-font ico-store-icon"></i><Link to={`?page=marketplace-manager-settings&name=${data.tabname}`} >{data.tablabel}</Link></li>
          ))}
          </ul>
