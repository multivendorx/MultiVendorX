...
/*
    ...
    public function mvx_list_all_vendor($specific_id = array()) {
        ...
        foreach($users as $user) {
            ...
            $name_display = "<div class='mvx-vendor-icon-name'><img src='". $MVX->plugin_url.'assets/images/dclogo.png' ."' width='20' height='20' ></img><b><a href='". sprintf('?page=%s&ID=%s&name=vendor_personal', 'mvx#&submenu=vendor', $user->data->ID) ."'>" . $user->data->display_name . "</a>|   |<a href='".$vendor->permalink."'>Shop</a></b></div>";
