...
class MVX_Deprecated_Action_Hooks extends WC_Deprecated_Hooks {
	...
	protected $deprecated_hooks = array(
        'mvx_settings_tools_action_default_case' => 'wcmp_settings_tools_action_default_case',
        'before_mvx_to_do_list' => 'before_wcmp_to_do_list',
        'mvx_todo_pending_vendor_approval_table_header' => 'wcmp_todo_pending_vendor_approval_table_header',
        'mvx_todo_pending_vendor_approval_table_row_data' => 'wcmp_todo_pending_vendor_approval_table_row_data',
        'mvx_todo_pending_coupon_approval_table_row_data' => 'wcmp_todo_pending_coupon_approval_table_row_data',
        'mvx_todo_pending_product_approval_table_row_data' => 'wcmp_todo_pending_product_approval_table_row_data',
        'mvx_todo_pending_bank_transfer_exporter_form_fields' => 'wcmp_todo_pending_bank_transfer_exporter_form_fields',
        'mvx_todo_pending_bank_transfer_table_row_data' => 'wcmp_todo_pending_bank_transfer_table_row_data',
        'after_mvx_to_do_list' => 'after_wcmp_to_do_list',
        'mvx_vendor_process_bulk_action' => 'wcmp_vendor_process_bulk_action',
        'mvx_vendor_details_update' => 'wcmp_vendor_details_update',
        'mvx_vendor_preview_tabs_pre' => 'wcmp_vendor_preview_tabs_pre',
        'mvx_vendor_preview_tabs_post' => 'wcmp_vendor_preview_tabs_post',
        'mvx_vendor_preview_tabs_form_pre' => 'wcmp_vendor_preview_tabs_form_pre',
        'mvx_vendor_preview_tabs_form_post' => 'wcmp_vendor_preview_tabs_form_post',
        'mvx_admin_vendor_preview_start' => 'wcmp_admin_vendor_preview_start',
        'mvx_admin_vendor_preview_end' => 'wcmp_admin_vendor_preview_end',
        'settings_page_mvx-addons_tab_init' => 'settings_page_wcmp-addons_tab_init',
        ...
        'mvx_save_vendor_commission' => 'wcmp_save_vendor_commission',
        ...
        'after_register_mvx_vendor' => 'after_register_wcmp_vendor',
        ...
        'before_mvx_vendor_tools_content' => 'before_wcmp_vendor_tools_content',
        'mvx_vendor_dashboard_tools_item' => 'wcmp_vendor_dashboard_tools_item',
        'after_mvx_vendor_tools_content' => 'after_wcmp_vendor_tools_content',
        ...
        'mvx_afm_coupon_write_panel_tabs' => 'wcmp_afm_coupon_write_panel_tabs',
        'mvx_afm_coupon_tabs_content' => 'wcmp_afm_coupon_tabs_content',
        'mvx_afm_add_coupon_form_end' => 'wcmp_afm_add_coupon_form_end',
        'after_mvx_afm_add_coupon_form' => 'after_wcmp_afm_add_coupon_form',
        'before_mvx_vendor_dashboard_coupon_list_table' => 'before_wcmp_vendor_dashboard_coupon_list_table',
        ...
        'mvx_afm_before_usage_limit_coupon_data' => 'wcmp_afm_before_usage_limit_coupon_data',
        'mvx_afm_after_usage_limit_coupon_data' => 'wcmp_afm_after_usage_limit_coupon_data',
        'mvx_afm_before_usage_restriction_coupon_data' => 'wcmp_afm_before_usage_restriction_coupon_data',
        'mvx_afm_after_usage_restriction_coupon_data' => 'wcmp_afm_after_usage_restriction_coupon_data',
        'before_mvx_vendor_pending_shipping' => 'before_wcmp_vendor_pending_shipping',
        'after_mvx_vendor_pending_shipping' => 'after_wcmp_vendor_pending_shipping',
        'before_mvx_vendor_dashboard_products_cust_qna' => 'before_wcmp_vendor_dashboard_products_cust_qna',
        'after_mvx_vendor_dashboard_products_cust_qna' => 'after_wcmp_vendor_dashboard_products_cust_qna',
        'before_mvx_vendor_stats_reports' => 'before_wcmp_vendor_stats_reports',
        'after_mvx_vendor_stats_reports' => 'after_wcmp_vendor_stats_reports',
        'before_mvx_vendor_visitors_map' => 'before_wcmp_vendor_visitors_map',
        'after_mvx_vendor_visitors_map' => 'after_wcmp_vendor_visitors_map',
        'mvx-frontend-product-manager_template' => 'wcmp-frontend-product-manager_template',
        'before_mvx_add_product_form' => 'before_wcmp_add_product_form',
        ...
        'mvx_afm_after_product_excerpt_metabox_panel' => 'wcmp_afm_after_product_excerpt_metabox_panel',
        ...
        'after_mvx_product_tags_metabox_panel' => 'after_wcmp_product_tags_metabox_panel',
        'mvx_add_product_form_end' => 'wcmp_add_product_form_end',
        'after_mvx_add_product_form' => 'after_wcmp_add_product_form',
        'before_mvx_vendor_dashboard_product_list_table' => 'before_wcmp_vendor_dashboard_product_list_table',
        'mvx_products_list_add_extra_filters' => 'wcmp_products_list_add_extra_filters',
        'before_mvx_vendor_dash_product_list_page_header_action_btn' => 'before_wcmp_vendor_dash_product_list_page_header_action_btn',
        'after_mvx_vendor_dash_product_list_page_header_action_btn' => 'after_wcmp_vendor_dash_product_list_page_header_action_btn',
        'after_mvx_vendor_dashboard_product_list_table' => 'after_wcmp_vendor_dashboard_product_list_table',
        'mvx_afm_product_option_terms' => 'wcmp_afm_product_option_terms',
        'mvx_afm_after_product_attribute_settings' => 'wcmp_afm_after_product_attribute_settings',
        'mvx_afm_product_options_advanced' => 'wcmp_afm_product_options_advanced',
        'mvx_afm_product_options_attributes' => 'wcmp_afm_product_options_attributes',
        'mvx_afm_before_general_product_data' => 'wcmp_afm_before_general_product_data',
        'mvx_afm_product_options_pricing' => 'wcmp_afm_product_options_pricing',
        'mvx_afm_product_options_downloads' => 'wcmp_afm_product_options_downloads',
        'mvx_afm_after_general_product_data' => 'wcmp_afm_after_general_product_data',
        'mvx_afm_product_options_sku' => 'wcmp_afm_product_options_sku',
        'mvx_afm_product_options_stock_description' => 'wcmp_afm_product_options_stock_description',
        'mvx_afm_product_options_stock' => 'wcmp_afm_product_options_stock',
        'mvx_afm_product_options_stock_fields' => 'wcmp_afm_product_options_stock_fields',
        'mvx_afm_product_options_stock_status' => 'wcmp_afm_product_options_stock_status',
        'mvx_afm_product_options_sold_individually' => 'wcmp_afm_product_options_sold_individually',
        'mvx_afm_after_inventory_section_ends' => 'wcmp_afm_after_inventory_section_ends',
        'mvx_afm_product_options_inventory_product_data' => 'wcmp_afm_product_options_inventory_product_data',
        'mvx_afm_product_options_related' => 'wcmp_afm_product_options_related',
        'mvx_afm_before_vendor_policies' => 'wcmp_afm_before_vendor_policies',
        'mvx_afm_after_vendor_policies' => 'wcmp_afm_after_vendor_policies',
        'mvx_afm_product_options_dimensions' => 'wcmp_afm_product_options_dimensions',
        'mvx_afm_product_options_shipping' => 'wcmp_afm_product_options_shipping',
        'mvx_afm_before_product_highlights_category_wrap' => 'wcmp_afm_before_product_highlights_category_wrap',
        'mvx_afm_after_product_highlights_category_wrap' => 'wcmp_afm_after_product_highlights_category_wrap',
        'mvx_afm_before_product_highlights_title_wrap' => 'wcmp_afm_before_product_highlights_title_wrap',
        'mvx_afm_after_product_highlights_title_wrap' => 'wcmp_afm_after_product_highlights_title_wrap',
        'mvx_vendor_dash_order_details_before_top_left_data' => 'wcmp_vendor_dash_order_details_before_top_left_data',
        'mvx_vendor_dash_order_details_after_top_left_data' => 'wcmp_vendor_dash_order_details_after_top_left_data',
        'mvx_vendor_dash_order_details_top_right_data' => 'wcmp_vendor_dash_order_details_top_right_data',
	...
	protected $deprecated_version = array(
        'wcmp_settings_tools_action_default_case' => '4.0.0',
        'before_wcmp_to_do_list' => '4.0.0',
        'wcmp_todo_pending_vendor_approval_table_header' => '4.0.0',
        'wcmp_todo_pending_vendor_approval_table_row_data' => '4.0.0',
        'wcmp_todo_pending_coupon_approval_table_row_data' => '4.0.0',
        'wcmp_todo_pending_product_approval_table_row_data' => '4.0.0',
        'wcmp_todo_pending_bank_transfer_exporter_form_fields' => '4.0.0',
        'wcmp_todo_pending_bank_transfer_table_row_data' => '4.0.0',
        'after_wcmp_to_do_list' => '4.0.0',
        'wcmp_vendor_process_bulk_action' => '4.0.0',
        'wcmp_vendor_details_update' => '4.0.0',
        'wcmp_vendor_preview_tabs_pre' => '4.0.0',
        'wcmp_vendor_preview_tabs_post' => '4.0.0',
        'wcmp_vendor_preview_tabs_form_pre' => '4.0.0',
        'wcmp_vendor_preview_tabs_form_post' => '4.0.0',
        'wcmp_admin_vendor_preview_start' => '4.0.0',
        'wcmp_admin_vendor_preview_end' => '4.0.0',
        'settings_page_wcmp-addons_tab_init' => '4.0.0',
        ...
        'wcmp_save_vendor_commission' => '4.0.0',
