...
echo '<div class="col-md-12 text-center"><div class="panel mvx-rejected-vendor-notice">' . apply_filters( 'mvx_rejected_vendor_dashboard_message', __('We have reviewed your application. Unfortunately, you are not the right fit with us at this time.', 'dc-woocommerce-multi-vendor') ) . '</div></div>';
...
echo '<div class="mvx-action-container"><a class="btn btn-default" href="' . esc_url(mvx_get_vendor_dashboard_endpoint_url('rejected-vendor-reapply')) . '">' . __('Resubmit Application', 'dc-woocommerce-multi-vendor') . '</a></div>';
