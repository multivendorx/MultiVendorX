...
<div class="mvx-product-policies">
    ...
    <div class="mvx-shipping-policies policy">
        <h2 class="mvx_policies_heading heading"><?php echo apply_filters('mvx_shipping_policies_heading', esc_html_e('Shipping Policy', 'dc-woocommerce-multi-vendor')); ?></h2>
    ...
    <div class="mvx-refund-policies policy">
        <h2 class="mvx_policies_heading heading heading"><?php echo apply_filters('mvx_refund_policies_heading', esc_html_e('Refund Policy', 'dc-woocommerce-multi-vendor')); ?></h2>
    ...
    <div class="mvx-cancellation-policies policy">
        <h2 class="mvx_policies_heading heading"><?php echo apply_filters('mvx_cancellation_policies_heading', esc_html_e('Cancellation / Return / Exchange Policy', 'dc-woocommerce-multi-vendor')); ?></h2>
