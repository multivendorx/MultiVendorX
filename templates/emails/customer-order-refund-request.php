...
<div style="font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; margin-bottom: 40px;">
    <?php if( $user_type != 'customer' ) { ?>
		...
		<ul>
				<li><strong><?php _e( 'Order ID', 'dc-woocommerce-multi-vendor' ); ?>:</strong> <span class="text"><a href="<?php echo esc_url( mvx_get_vendor_dashboard_endpoint_url( get_mvx_vendor_settings('mvx_vendor_orders_endpoint', 'seller_dashbaord', 'vendor-orders'), $order->get_id() ) ); ?>" target="_blank">#<?php echo $order->get_id(); ?></a></span></li>
