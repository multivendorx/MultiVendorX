...
<div class="mvx_regi_main">
    <form class="register" role="form" method="post" enctype="multipart/form-data">
        <h2 class="reg_header1"><?php echo apply_filters('mvx_vendor_registration_header_text',__('Vendor Registration Form','dc-woocommerce-multi-vendor')); ?></h2>
        ...
        <p class="woocomerce-FormRow form-row">
            <?php 
            $button_text = apply_filters('mvx_vendor_registration_submit',__('Register', 'dc-woocommerce-multi-vendor'));
            ?>
