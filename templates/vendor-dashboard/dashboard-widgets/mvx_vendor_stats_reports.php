...
<div class="pannel panel-default pannel-outer-heading staticstics-panel-wrap">
    <div class="panel-body">
        <h2><i class="mvx-font ico-report-icon"></i> <?php printf( __( 'Your Store Report - %s', 'dc-woocommerce-multi-vendor' ), '<span class="_mvx_stats_period"></span>' );?></h2>
        <div class="row">
            <div class="col-md-4 key-perfomence-indicator">
                ...
                <ul class="short-stat-info-list">
                    <li>
                        <span class="stat-icon" title="<?php _e('Traffic', 'dc-woocommerce-multi-vendor'); ?>"><i class="mvx-font ico-visit-icon"></i></span>
                    ...
                    <li>
                        <span class="stat-icon" title="<?php _e('Order No', 'dc-woocommerce-multi-vendor'); ?>"><i class="mvx-font ico-cart-icon"></i></span>
                    ...
                    <li>
                        <span class="stat-icon" title="<?php _e('Sales', 'dc-woocommerce-multi-vendor'); ?>"><i class="mvx-font ico-price2-icon"></i></span>
                ...
                <ul class="short-stat-info-list">
                    <li>
                        <span class="stat-icon" title="<?php _e('Earning', 'dc-woocommerce-multi-vendor'); ?>"><i class="mvx-font ico-earning-icon"></i></span>
                    ...
                    <li>
                        <span class="stat-icon" title="<?php _e('Withdrawal', 'dc-woocommerce-multi-vendor'); ?>"><i class="mvx-font ico-revenue-icon"></i></span>
            ...
            <div class="col-md-8">
                ...
                <p class="stat-detail-info"><span><i class="mvx-font ico-avarage-order-value-icon"></i></span> <?php printf( __( 'Your average order value %1$s for this span was %2$s', 'dc-woocommerce-multi-vendor' ), '<strong>(AOV)</strong>', '<span class="_mvx_stats_aov stats-aov"></span>'); ?> </p>
                <p class="stat-detail-info"><span><i class="mvx-font ico-revenue-icon"></i></span> <?php printf( __( 'During this span, %1$s has been credited to your %2$s account, as commission.', 'dc-woocommerce-multi-vendor' ), '<mark class="_mvx_stats_table current_withdrawal withdrawal-label mark-green"></mark>', $payment_mode); ?></p>
                ...
                <ul class="mvx-website-stat-list">
                    <li>
                        ...
                        <span><?php _e('Store traffic', 'dc-woocommerce-multi-vendor'); ?> <mark id="stats-diff-traffic" class="_mvx_diff_traffic_no "></mark></span>
                    </li>
                    <li>
                        <span><i class="mvx-font ico-cart-icon"></i></span>
                        <span><?php _e('Received orders', 'dc-woocommerce-multi-vendor'); ?> <mark id="stats-diff-order-no" class="_mvx_diff_orders_no "></mark></span>
                    </li> 
                    <li>
                        <span><i class="mvx-font ico-price2-icon"></i></span>
                        <span><?php _e('Total sales', 'dc-woocommerce-multi-vendor'); ?> <mark id="stats-diff-sales-total" class="_mvx_diff_sales_total "></mark></span>
                    </li>
                    
                    <li>
                        <span><i class="mvx-font ico-earning-icon"></i></span>
                        <span><?php _e('Your earning', 'dc-woocommerce-multi-vendor'); ?> <mark id="stats-diff-earning" class="_mvx_diff_earning "></mark></span>
                    </li>
                </ul>
            </div>
        </div>
