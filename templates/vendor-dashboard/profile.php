                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9">
                            ...
                            <div class="mvx-do-change-pass">
                                <button type="button" class="btn btn-secondary" id="mvx-change-pass"><?php _e('Change Password', 'dc-woocommerce-multi-vendor'); ?></button>
                            </div>
                        </div>  
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9">
							...
							<div class="mvx-media profile-pic-btn">
								<button type="button" class="btn btn-secondary mvx_upload_btn" data-target="vendor-profile"><i class="mvx-font ico-edit-pencil-icon"></i> <?php _e('Upload image', 'dc-woocommerce-multi-vendor'); ?></button>
							</div>
