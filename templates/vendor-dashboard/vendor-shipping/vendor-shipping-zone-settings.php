...
<div class="zone-component panel-content-padding">
	<div class="shipping-zone-list">
		<a href="javascript:void(0);" ><i class="mvx-font ico-back-arrow"></i> <?php  esc_html_e('Shipping Zones', 'dc-woocommerce-multi-vendor'); ?></a>
		<hr>
	</div>
	...
	<div class="mvx-zone-method-wrapper form-group mt-10">
		...
		<div class="mvx-zone-method-content col-md-9 col-sm-9">
							...
							<tr id="item-<?php echo $vendor_shipping_method['instance_id'] ?>">
								...
								<td>
									<div class="col-actions edit_del_actions" data-zone_id="<?php echo esc_attr($zone_id); ?>" data-instance_id="<?php echo esc_attr($vendor_shipping_method['instance_id']); ?>" data-method_id="<?php echo esc_attr($vendor_shipping_method['id']); ?>" data-method-settings='<?php echo json_encode($vendor_shipping_method); ?>'>
										<span class="edit"><a href="javascript:void(0);" class="edit-shipping-method" title="<?php esc_attr_e( 'Edit', 'dc-woocommerce-multi-vendor' ) ?>"><i class="mvx-font ico-edit-pencil-icon"></i></a>
										</span>|
										<span class="delete"><a class="delete-shipping-method" href="javascript:void(0);" title="<?php esc_attr_e( 'Delete', 'dc-woocommerce-multi-vendor' ) ?>"><i class="mvx-font ico-delete-icon"></i></a></span>
									</div>
								</td>
							</tr>
						<?php 
			...
			<a href="javascript:void(0);" class="btn btn-default mvx-zone-method-add-btn show-shipping-methods"><i class="fa fa-plus"></i><?php esc_html_e( 'Add Shipping Method', 'dc-woocommerce-multi-vendor' ) ?></a>
		</div>
		<?php 
