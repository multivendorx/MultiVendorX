        ...
        <form name="mvx_vendor_dashboard_stat_report" method="POST" class="stat-date-range form-inline">
            <div class="mvx_form1 ">
                <div class="panel-heading d-lg-flex">
                    ...
                    <div class="form-group">
                        <button name="submit_button" type="submit" value="Show" class="mvx_black_btn btn btn-default"><?php esc_html_e('Show', 'dc-woocommerce-multi-vendor'); ?></button>
                    </div> 
                    <?php if (apply_filters('can_mvx_vendor_export_orders_csv', true, get_current_vendor_id())) : ?>
                    <div class="form-group">
                        <button type="submit" class="mvx_black_btn btn btn-default" name="mvx_stat_export" value="export"><?php esc_html_e('Download CSV', 'dc-woocommerce-multi-vendor'); ?></button>
                    </div> 
                    <?php endif; ?>
                </div>
