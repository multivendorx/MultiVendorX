            ...
            <ul class="order_notes list-group mb-0">
                ...
                <li class="list-group-item list-group-item-action flex-column align-items-start add_note">
                    ...
                    <?php wp_nonce_field('dc-vendor-add-order-comment', 'vendor_add_order_nonce'); ?> 
                        ...
                        <input class="btn btn-default mvx-add-order-note" type="submit" name="mvx_submit_comment" value="<?php _e('Submit', 'dc-woocommerce-multi-vendor'); ?>">
                    </form>  
                    <?php endif; ?>  
                </li>
                <?php if (mvx_is_module_active('vendor-shipping') === true) : ?>
                ...
                <li id="shipping_tracking_wrap" class="shipping_tracking collapse" style="padding:  10px 15px;;">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary" name="mvx-submit-mark-as-ship"><?php _e('Submit', 'dc-woocommerce-multi-vendor'); ?></button>
                        </div>
                    </form>
                </li>
                <?php endif; ?>
