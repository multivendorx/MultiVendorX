...
if (!class_exists('WC_Email_Vendor_Commission_Transactions')) :
    ...
    class WC_Email_Vendor_Commission_Transactions extends WC_Email {
        ...
        public function get_default_subject() {
            return apply_filters('mvx_vendor_commissions_transaction_email_subject', __('[{site_title}] New Transaction', 'dc-woocommerce-multi-vendor'), $this->object);
        }
        ...
        public function get_default_heading() {
            return apply_filters('mvx_vendor_commissions_transaction_email_heading', __('Vendor\'s New Transaction', 'dc-woocommerce-multi-vendor'), $this->object);
        }
