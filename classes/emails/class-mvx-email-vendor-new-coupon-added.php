...
if (!class_exists('WC_Email_Vendor_New_Coupon_Added')) :
    ...
    class WC_Email_Vendor_New_Coupon_Added extends WC_Email {
        ...
        public function get_default_subject() {
            return apply_filters('mvx_admin_new_vendor_coupon_email_subject', __('[{blogname}] New coupon submitted by {vendor_name} - {coupon_name}', 'dc-woocommerce-multi-vendor'), $this->object);
        }
        ...
        public function get_default_heading() {
            return apply_filters('mvx_admin_new_vendor_coupon_email_heading', __('New coupon submitted: {coupon_name}', 'dc-woocommerce-multi-vendor'), $this->object);
        }
