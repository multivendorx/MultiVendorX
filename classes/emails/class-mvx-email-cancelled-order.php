<?php
/**
 * Class WC_Email_Vendor_Cancelled_Order file.
 *
...
if ( ! class_exists( 'WC_Email_Vendor_Cancelled_Order', false ) ) :
	 ...
	 *
	 * @class       WC_Email_Vendor_Cancelled_Order
	 * @version     2.2.7
	 * @package     WooCommerce\Classes\Emails
	 * @extends     WC_Email
	 */
	class WC_Email_Vendor_Cancelled_Order extends WC_Email {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->id             = 'mvx_vendor_cancelled_order';
			$this->title          = __( 'Vendor Cancelled order', 'woocommerce' );
		...
		public function trigger( $order_id, $order = false ) {
			...
			foreach ($items as $item_id => $item) {
				if (isset($item['product_id']) && $item['product_id'] !== 0) {
					...
					$vendor_email = $has_vendor->user_data->user_email;
...
return new WC_Email_Vendor_Cancelled_Order();
