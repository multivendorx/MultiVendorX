...
if (!class_exists('WC_Email_Vendor_Product_Approved')) :

    /**
     * Customer New Account
     *
     * An email sent to the customer when admin approve a product.
     *
     * @class 		WC_Email_Vendor_Product_Approved
     * @version		3.5.1
     * @package		MultivendorX/Classes/Emails
     * @author 		WooThemes
     * @extends 	WC_Email
     */
    class WC_Email_Vendor_Product_Approved extends WC_Email {
        ...
        function __construct() {
            ...
            $this->id = 'admin_vendor_product_approved';

            $this->title = __('Vendor Product Approved', 'multivendorx');
            $this->description = __('Notification emails are sent when a product is approved by an admin.', 'multivendorx');
            ...
            $this->template_html = 'emails/product-approved.php';
            $this->template_plain = 'emails/plain/product-approved.php';
        ...
        public function get_default_subject() {
            return apply_filters('mvx_admin_new_vendor_product_email_subject', __('[{blogname}] Submitted Product Approved by {vendor_name} - {product_name}', 'multivendorx'), $this->object);
        }
        ...
        public function get_default_heading() {
            return apply_filters('mvx_admin_new_vendor_product_email_heading', __('Submitted Product Approved: {product_name}', 'multivendorx'), $this->object);
        }
