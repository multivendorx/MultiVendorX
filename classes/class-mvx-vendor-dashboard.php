...
Class MVX_Admin_Dashboard {
    ...
    public function save_store_settings($user_id, $post) {
        ...
        if(isset($_POST['vendor_shop_address_hide']) && !empty($_POST['vendor_shop_address_hide'])){
            update_user_meta($user_id,'_vendor_hide_address',$_POST['vendor_shop_address_hide']);
        } else {
            update_user_meta($user_id,'_vendor_hide_address','disable');
        }
        if(isset($_POST['vendor_shop_phone_hide']) && !empty($_POST['vendor_shop_phone_hide'])){
            update_user_meta($user_id,'_vendor_hide_phone',$_POST['vendor_shop_phone_hide']);
        } else {
            update_user_meta($user_id,'_vendor_hide_phone','disable');
        }
        if(isset($_POST['vendor_shop_email_hide']) && !empty($_POST['vendor_shop_email_hide'])){
            update_user_meta($user_id,'_vendor_hide_email',$_POST['vendor_shop_email_hide']);
        } else {
            update_user_meta($user_id,'_vendor_hide_email','disable');
        }
