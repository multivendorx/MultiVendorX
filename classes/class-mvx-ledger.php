    ...
    public function mvx_commission_after_save_commission_total( $commission_id, $order ){
        if( $order ){
            ...
            $data = array(
                ...
                'ref_type'      => 'commission',
                'ref_info'      => sprintf(__('Commission generated for Order &ndash; <a href="%s" target="_blank">#%s</a>', 'dc-woocommerce-multi-vendor'), esc_url(mvx_get_vendor_dashboard_endpoint_url(get_mvx_vendor_settings('mvx_vendor_orders_endpoint', 'seller_dashbaord', 'vendor-orders'), $order->get_id())), $order->get_id()),
                'ref_status'    => 'unpaid',
            ...
            if( $commissions ){
                foreach ( $commissions as $commission_id ) {
                    ...
                    $data = array(
                        ...
                        'ref_type'      => 'withdrawal',
                        'ref_info'      => sprintf(__('Withdrawal generated for Commission &ndash; <a href="%s" target="_blank">#%s</a>', 'dc-woocommerce-multi-vendor'), esc_url(mvx_get_vendor_dashboard_endpoint_url(get_mvx_vendor_settings('mvx_transaction_details_endpoint', 'seller_dashbaord', 'transaction-details'), $transaction_id)), $commission_id),
    ...
    public function before_commission_delete( $post_id ) {
        ...
        if( $vendor ) :
            ...
            $data = array(
                ...
                'ref_id'        => $post_id,
                'ref_type'      => 'commission',
                'ref_info'      => sprintf(__('Commission cancelled for Order &ndash; <a href="%s" target="_blank">#%s</a>', 'dc-woocommerce-multi-vendor'), esc_url(mvx_get_vendor_dashboard_endpoint_url(get_mvx_vendor_settings('mvx_vendor_orders_endpoint', 'seller_dashbaord', 'vendor-orders'), $order_id)), $order_id),
