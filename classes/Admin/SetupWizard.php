...
class SetupWizard {
    ...
    public function setup_wizard() {
        ...
        if (! MVX()->is_woocommerce_installed()) {
    ...
    public function mvx_setup_introduction() {
        ...
        <p><?php echo wp_kses_post('Thank you for choosing MultivendorX! This quick setup wizard will help you configure the basic settings and you will have your marketplace ready in no time. <strong>It’s completely optional and shouldn’t take longer than five minutes.</strong>'); ?></p>
