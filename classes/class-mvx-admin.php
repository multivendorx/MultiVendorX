...
class MVX_Admin {
    ...
    public function enqueue_admin_script() {
        ...
        $workboard_string = array(
            'workboard1'                 =>  __('Pending Product Approval', 'multivendorx'),
            'workboard2'                 =>  __('Pending Vendor Product', 'multivendorx'),
            'workboard3'                 =>  __('Product Name', 'multivendorx'),
            'workboard4'                 =>  __('Shop', 'multivendorx'),
            'workboard5'                 =>  __('No Product Found', 'multivendorx'),
            'workboard6'                 =>  __('Pending Vendor Approval', 'multivendorx'),
            'workboard7'                 =>  __('Pending User', 'multivendorx'),
            'workboard8'                 =>  __('Vendor Name', 'multivendorx'),
            'workboard9'                 =>  __('No Vendor Found', 'multivendorx'),
            'workboard10'                 =>  __('Pending Coupon', 'multivendorx'),
            'workboard11'                 =>  __('Coupon Name', 'multivendorx'),
            'workboard12'                 =>  __('No Coupon Found', 'multivendorx'),
            'workboard13'                 =>  __('Pending Transaction', 'multivendorx'),
            'workboard15'                 =>  __('Commission', 'multivendorx'),
            'workboard16'                 =>  __('Amount', 'multivendorx'),
            'workboard17'                 =>  __('Account Detail', 'multivendorx'),
            'workboard18'                 =>  __('No Transaction Found', 'multivendorx'),
            'workboard19'                 =>  __('Pending Question Approval', 'multivendorx'),
            'workboard20'                 =>  __('Pending Question', 'multivendorx'),
            'workboard21'                 =>  __('Question by', 'multivendorx'),
            'workboard22'                 =>  __('Product Name', 'multivendorx'),
            'workboard23'                 =>  __('Question details', 'multivendorx'),
            'workboard24'                 =>  __('No Question Found', 'multivendorx'),
            ...
            'workboard29'                 =>  __('Search Review', 'multivendorx'),
            ...
            'workboard34'                 =>  __('Search product status', 'multivendorx'),
        );
