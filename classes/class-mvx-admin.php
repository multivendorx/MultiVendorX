...
class MVX_Admin {
    ...
    public function admin_service_page_notice() {
        ...
        <div class="mvx_admin_new_banner" id="mvx_service_banner">
            <div class="mvx-beta-logo">
                <img src="<?php echo esc_url( $MVX->plugin_url . 'assets/images/vertical-logo-white.png' ); ?>" alt="beta-logo">
            </div>
            <div class="mvx-banner-content">
                <h1 class="mvx-banner-title">Black Friday Mega Deal!</h1>
        ...
        .notice-dismiss:before,.notice-dismiss:hover:before{
            color:white;
            opacity:.4
        }
        .mvx-beta-logo{
    ...
    // Dismiss the notice and save the status
